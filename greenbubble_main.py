...
def main():
    ...
    # ---- Optimize
    n_flags_opt = {'print': True, 'export': True, 'plot': False}
    solve_network(network, solver="gurobi", profile="gurobi-default", assign_all_duals=True)# or "highs" (select solver options from solver_profiles_old.py)
